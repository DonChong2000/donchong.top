...
function LinkedIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
...
function MailIcon2(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg fill="none" viewBox="0 0 20 20" aria-hidden="true" {...props}>
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row dark:border-white/5">
      ...
      <div className="flex gap-4">
        ...
        <SocialLink href="https://www.linkedin.com/in/shing-tung-chong-bb5643225/" icon={LinkedIcon}>
          Follow me on LinkedIn
        </SocialLink>

        <SocialLink href="https://github.com/DonChong2000" icon={GitHubIcon}>
          Follow me on GitHub
        </SocialLink>

        <SocialLink href="https://www.youtube.com/@DonChong2000" icon={YoutubeIcon}>
          Follow me on YouTube
        </SocialLink>

        <SocialLink href="https://www.instagram.com/donchong2000/" icon={InstagramIcon}>
          Follow me on Instagram
        </SocialLink>

        <SocialLink href="mailto:donchong2000@gmail.com" icon={MailIcon2}>
          Reach me via Email
        </SocialLink>
