...
- **Power Generation** — Cetane diesel vs. benzene, with a Large Gas Turbine setup fed by an 11×11 EnderIO tree farm
...
- **Buildings** — Seagram-inspired rebuild of the “04” Industrial Center
