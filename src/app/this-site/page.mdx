...
#### [The theme](#color)
<div className="flex flex-col items-center justify-center h-20 bg-timberwolf-500 w-1/3">
...
<div className="flex flex-col items-center justify-center h-20 bg-gamboge-500 w-1/3">
  <span>Gamboge</span>
  <span>#EC9A29</span>
</div>

The color them of this site is from a random picture that caught my eyes.
