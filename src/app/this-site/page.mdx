...
I built this site for several reasons.
First, I wanted to deepen my understanding of modern frontend technologies. Although I work as a full-stack programmer at IBM, I know my frontend skills still have a lot of room for improvement. The last time I built a website was back in high school, when jQuery was the go-to framework. Since then, the frontend landscape has evolved dramatically, and I haven’t kept up as well as I’d like. So, I decided to build this site as a way to learn new tools and frameworks and hopefully improve my design sense along the way.

Another reason is that I want interviewers and colleagues to see a more complete picture of who I am. In an era where AI-generated resumes, cover letters, and even personal statements have become commonplace, much of what we read online often feels hollow. I’m tired of content that lacks authenticity. I value work that carries a sense of warmth, something that clearly reflects real effort and genuine thought.

To stand out from the flood of AI-generated content, I believe the best way is to express a vivid personality, to document my learning journey, share my thought process, and show that there is a real human behind the words.

I don’t claim to be an expert, but this site represents what I’ve learned and where I’ve been. Hopefully, it gives you a better sense of my skills and personality, and helps you decide whether I might be a good fit for your team.
# Building My Site
