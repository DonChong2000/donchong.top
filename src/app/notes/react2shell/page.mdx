...
export const metadata = {
  priority: 0,
  title: 'React2Shell',
  description: 'An incident report that documents the React2Shell compromise tied to CVE-2025-55182 (Common Vulnerabilities and Exposures) to capture indicators, impact, and recovery steps. Built with Oracle Cloud monitoring, systemd service inspection, and Next.js, focusing on tracing a crypto-mining process pinned at 100% usage and patching from 15.5.2 to 15.5.7.',
};
