...
export const metadata = {
  ...
  description:
    'A technical retrospective on completing the Grind 75 curriculum in TypeScript, featuring performance tips for JavaScript data structures and summaries of core algorithmic patterns.',
};
