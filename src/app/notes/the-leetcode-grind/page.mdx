...
export const metadata = {
  ...
  description:
    'A study log that recounts finishing Grind 75 in about eight weeks (27 coding days) to capture algorithm patterns and performance pitfalls. Built with TypeScript, LeetCode, ECMAScript references, and V8 Map/Set benchmarks, focusing on time-complexity tradeoffs in JavaScript data structures.',
};
