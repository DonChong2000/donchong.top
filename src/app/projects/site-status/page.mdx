...
> tldr: If you want to monitor your site and services, use <a href="#simple-solution">UptimeRobot</a>.
...
Since I was play [TFG Modpack](https://www.curseforge.com/minecraft/modpacks/terrafirmagreg-modern) with my friends,
food will expire if I keep the server running 24/7, so I need a way to let my friends start the server when they want to play. 
