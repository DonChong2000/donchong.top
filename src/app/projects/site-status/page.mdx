...
export const metadata = {
  ...
  title: 'Status',
  description:
    'A status dashboard that checks my sites and services and can start a Minecraft server to avoid keeping it running 24/7. Built with Cloudflare Workers, Node.js, mcstatus.io, and an Oracle Cloud server, focusing on a one-click server start from the status page.',
};
