...
export const metadata = {
  ...
  description:
    'A Discord bot that turns cooking videos into structured recipes to make hands-free cooking easier. Built with Discord, Cloudflare Workers, whisper-large-v3-turbo, and Gemini, focusing on parallel transcription that cut processing time by 60% (55 seconds) in a sample test.',
};
