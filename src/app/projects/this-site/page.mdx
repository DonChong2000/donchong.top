...
<div className="flex justify-center w-full gap-5">
  <Image src={'/images/this-site/Pasted%20image%2020250820160328.png'} alt='Image size difference' />
  <Image src={'/images/this-site/Picture3.png'} alt='loading blur image sample'/>
</div>
