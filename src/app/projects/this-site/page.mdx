...
export const metadata = {
  ...
  description:
    'A personal website that documents my work and design decisions to present my skills and projects clearly. Built with Next.js, Tailwind CSS, GitHub Actions, and Oracle Cloud (Ubuntu 22.04.4), focusing on automated deploys on each push.',
  thumbnail: '/thumbnial/this-site.png',
}


# Why am I building this site?
#frontend #backend #fullstack #VPS #nextJS #tailwind #vps #socketio #express
...
#### [CI/CD](#simple-ci-cd-with-git-hub-actions)
