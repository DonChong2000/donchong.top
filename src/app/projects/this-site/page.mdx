...
<div className="flex justify-center w-full gap-5">
  <Image src={'/images/projects/this-site/Pasted%20image%2020250820160328.png'} alt='Image size difference' width={348} height={255} />
  <Image src={'/images/projects/this-site/Picture3.png'} alt='loading blur image sample' width={257} height={255} />
</div>
