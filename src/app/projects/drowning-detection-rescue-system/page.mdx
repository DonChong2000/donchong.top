...
export const metadata = {
  ...
  description:
    'A drowning-detection and rescue system that uses a wearable beacon and computer vision to locate swimmers and deploy a robotic float to guide rescue. Built with a wearable light-emitting diode (LED) beacon, computer vision, a web app, and a robotic float, focusing on a 135 ms red-green signal that minimized yellow-frame errors in 30 fps tests.',
};
