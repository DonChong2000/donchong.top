...
export const metadata = {
  ...
  title: 'Bill-ai',
  description:
    'A Discord receipt-extraction bot that converts receipt photos into spreadsheet-ready line items to speed shared-expense bookkeeping. Built with Azure Document Intelligence (optical character recognition), Discord, Node.js, and OpenAI GPT-4o (Generative Pre-trained Transformer), focusing on grayscale preprocessing to stay under the 4 MB free-tier limit.',
};
