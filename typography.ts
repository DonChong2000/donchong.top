    ...
    typography: ({ theme }) => ({
      DEFAULT: {
        css: {
          ...
          '--tw-prose-headings': theme('colors.charcoal.460'),
          '--tw-prose-links': theme('colors.charcoal.400'),
          '--tw-prose-links-hover': theme('colors.charcoal.500'),
          '--tw-prose-links-underline': theme('colors.charcoal.400 / 0.6'),
          '--tw-prose-links-hover-underline': theme('colors.charcoal.300'),
          ...
          '--tw-prose-hr': theme('colors.charcoal.900 / 0.05'),
          '--tw-prose-quotes': theme('colors.charcoal.900'),
          '--tw-prose-quote-borders': theme('colors.charcoal.200'),
          '--tw-prose-captions': theme('colors.charcoal.500'),
          '--tw-prose-code': theme('colors.charcoal.700'),
          '--tw-prose-code-bg': theme('colors.timberwolf.100'),
          '--tw-prose-code-ring': theme('colors.timberwolf.300'),
          ...
          '--tw-prose-invert-headings': theme('colors.timberwolf.500'),
          '--tw-prose-invert-links': theme('colors.charcoal.300'),
          '--tw-prose-invert-links-hover': theme('colors.charcoal.400'),
          '--tw-prose-invert-links-underline': theme(
            'colors.charcoal.400',
          ),
          '--tw-prose-invert-links-hover-underline': theme('colors.charcoal.500'),
          ...
          '--tw-prose-invert-code-bg': theme('colors.charcoal.500/0.3'),
          '--tw-prose-invert-code-ring': theme('colors.timberwolf.800/0.4'),
      ...
      invert: {
        css: {
          ...
          '--tw-prose-links-hover-underline': 'var(--tw-prose-invert-links-hover-underline)',
